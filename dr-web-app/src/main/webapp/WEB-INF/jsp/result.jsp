...
<div>
    <div class="container-fluid text-justify" style="padding-bottom: 5px">
        <h4>Хорошо справилась!</h4>
        <p>Заслужила награду)</p>
        <p>
    ...
    <div class="container-fluid">
        <div id="mySlider" class="carousel slide" data-ride="carousel" data-interval="3000">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="url_photo" alt="24 слайд">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="url_photo" alt="2 слайд">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="url_photo" alt="25 слайд">
                </div>
            </div>
    ...
    <div class="container-fluid text-justify" style="padding-bottom: 5px">
        <p>Если досмотрела фотки, можешь вернуться к боту и написать ему команду "прошла",
